                        ...
                        <div className={classes.item_card}>
                            {
                                !this.state.error ?
                                    ...
                                    <div className={classes.item_card_image}>
                                        <img src={this.state.coffee[3]['url']} alt="coffee" width="392px" height="355px"/>
                                    </div>
                                    <div className={classes.content_theme}>
                                        ...
                                        <p className={classes.item_country}>Country: <span>{this.state.coffee[3]['country']}</span></p>
                                        <p className={classes.item_description}>Description: <span>{this.state.coffee[3]['description']}</span></p>
                                        <p className={classes.item_price}>Price: <span> {this.state.coffee[3]['price']}</span></p>
                                    </div>
                                    </>
                                : <Spinner />
